(function(){
	...
	function mul(){eqlNum.value = parseFloat(midNum[0].value) * parseFloat(midNum[1].value);
	}
	function div(){eqlNum.value = parseFloat(midNum[0].value) / parseFloat(midNum[1].value);
	}
	/* 演習1 ここまで */
